      ...
      <Grid container spacing={16}>
        <Grid item xs={6}>
          <FormControl className={classes.formControl}>
            <Field name="functionId" component={renderTextField} label="Function ID"/>
          </FormControl>
        </Grid>
        <Grid item xs={6}>
          <FormControl className={classes.formControl}>
            <InputLabel htmlFor="type">Type</InputLabel>
            <Field name="type" {...custom} component={renderSelectField} label="Type">
...
const StyledFunctionForm = withStyles(styles, {withTheme: true})(FunctionForm);
